...
export default function Header() {
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full p-2.5 fixed top-0 left-0 z-50 bg-background bg-zinc-950">
        <div className="absolute top-0 left-0 right-0 backdrop-blur w-full h-full -z-20" />
        <div className="flex gap-5 items-center">
          <Link href="/" passHref>
            <div className="h-5 m-0 cursor-pointer">
              <img alt="DGEN Logo" src="/dgen.png" className="h-full" />
            </div>
          </Link>
        </div>
